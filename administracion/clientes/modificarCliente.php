<?php
    ...
    if(isset($_POST['modificar'])){
        $dni = $_POST['dni'];
        $nombre = $_POST['nombre'];
        $primer = $_POST['primerApellido'];
        $segundo = $_POST['segundoApellido'];
        
        $resultadoFinal = $CRUD -> modificarCliente($dni,$nombre,$primer,$segundo);
    }
?>
...
<body>
    ...
    <main class="container">
        <div id="columnaContenido">
            <h2 id="tituloZona" class="text-center pt-2">Clientes</h2>
            <div class="d-flex justify-content-between">
                <a class="btn w-100 m-1 btn-outline-mismoColor " href="mostrarClientes.php">
                    <span class="d-none d-md-inline">Mostrar</span>
                    <span class="d-inline d-md-none"><i class="fa fa-eye"></i></span>
                </a>
                <a class="btn w-100 m-1 btn-outline-mismoColor " href="añadirCliente.php">
                    <span class="d-none d-md-inline">Añadir</span>
                    <span class="d-inline d-md-none"><i class="fa fa-plus-circle"></i></span>
                </a>
                <a class="btn w-100 m-1 btn-outline-mismoColor active" href="modificarCliente.php">
                    <span class="d-none d-md-inline">Modificar</span>
                    <span class="d-inline d-md-none"><i class="fa fa-edit"></i></span>
                </a>
                <a class="btn w-100 m-1 btn-outline-mismoColor" href="eliminarCliente.php">
                    <span class="d-none d-md-inline">Eliminar</span>
                    <span class="d-inline d-md-none"><i class="fa fa-trash"></i></span>
                </a>
            </div>
            <div id="tarjetasZona" class="row p-2 pr-3">
                <input id="buscadorModificarClientes" type="text" class="form-control mb-3" placeholder="Buscar...">
                        ...
                        <tbody id="listaClientes">
                            <?php
                                ...
                                foreach($resultado as $clave => $valor){
                                    echo "<tr>";
                                    echo '<form class="p-3" id="'.$valor["DNI"].'" name="formularioModificarCli" method="POST" action="#">';
                                    echo  "<td><button type='submit' name='modificar' class='btn btn-link'><img alt='modificarCliente' src='../../img/modificar.png' width='20px'></button></td>";
					                echo  "<td><input type='text' name='dni' value= '". $valor["DNI"] ."' readonly='readonly' size='9'><span class='d-none'>". $valor["DNI"] ."</span></td>";
					                echo  "<td><input type='text' name='nombre' value= '" . $valor["Nombre"] ."' maxlenght='30' size='20'><span class='d-none'>" . $valor["Nombre"] ."</span></td>";
					                echo  "<td><input type='text' name='primerApellido' value= '" . $valor["PrimerApellido"] ."' maxlenght='30' size='20'><span class='d-none'>" . $valor["PrimerApellido"] ."</span></td>";
                                    echo  "<td><input type='text' name='segundoApellido' value= '" . $valor["SegundoApellido"] ."' maxlenght='30' size='20'><span class='d-none'>" . $valor["SegundoApellido"] ."</span></td>";
                                    echo "</form>";
                                    echo "</tr>";
                                }
                            ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="alert alert-success m-0 text-center">
                        ...
                        <span id="textoCorrecto"><b>¡Correcto!</b> Se ha modificado un cliente con exito</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).ready(function(){
                $("#buscadorModificarClientes").on("keyup", function() {
