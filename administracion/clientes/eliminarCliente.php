<?php
    ...
    if(isset($_POST['eliminar'])){
        ...
        $resultadoFinal = $CRUD -> eliminarCliente($dni);
    }
?>
...
<body>
    ...
    <main class="container">
        <div id="columnaContenido">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a class="btn w-100 m-1 btn-outline-mismoColor" href="modificarCliente.php">
                    <span class="d-none d-md-inline">Modificar</span>
                    <span class="d-inline d-md-none"><i class="fa fa-edit"></i></span>
                </a>
                <a class="btn w-100 m-1 btn-outline-mismoColor active" href="eliminarCliente.php">
                    <span class="d-none d-md-inline">Eliminar</span>
                    <span class="d-inline d-md-none"><i class="fa fa-trash"></i></span>
                </a>
            </div>
            <div id="DNIsZona" class="row p-2 pr-3">
                <input id="buscadorEliminarClientes" type="text" class="form-control mb-3" placeholder="Buscar...">
                        ...
                        <tbody id="listaClientes">
                            <?php
                                ...
                                foreach($resultado as $clave => $valor){
                                    echo "<tr>";
                                    echo '<form class="p-3" id="'.$valor["DNI"].'" name="formularioEliminarCli" method="POST" action="#">';
                                    echo  "<td class='w-25'>
                                    <button type='button' id='opciones".$valor["DNI"]."' onclick=mostrarOpcionesBorrado('".$valor["DNI"]."') class='btn btn-link'>
                                        <img alt='eliminarAnimal' src='../../img/eliminar.png' width='20px'>
                                    </button>
                                    <button type='button' id='cancelar".$valor["DNI"]."' onclick=mostrarCancelarBorrado('".$valor["DNI"]."') class='btn botonMismoColor text-white m-1' style='display: none;'>Cancelar</button>
                                    <button type='submit' id='aceptar".$valor["DNI"]."' name='eliminar' class='btn botonMismoColor text-white m-1 pr-3 pl-3' style='display: none;'>Aceptar</button>
                                    </td>";
                                    ...
                                    echo "<td><input type='hidden' value=$valor[DNI] name='dni'>$valor[DNI]</td>";
                                    echo "<td>$valor[Nombre]</td>";
                                    echo "<td>$valor[PrimerApellido]</td>";
                                    echo "</form>";
                                    echo "</tr>";
                                }
                            ?>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="alert alert-success m-0 text-center">
                        ...
                        <span id="textoCorrecto"><b>¡Correcto!</b> Se ha eliminado un cliente con exito</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).ready(function(){
                $("#buscadorEliminarClientes").on("keyup", function() {
