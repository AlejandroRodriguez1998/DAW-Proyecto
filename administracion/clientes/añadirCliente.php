    ...
    if(isset($_POST['añadir'])){
        ...
        if($dni == "" || $nombre == "" || $primerApe == "" || $segundoApe == ""){
            ...
            if(preg_match("/^[0-9]{8,8}[A-Za-z]$/",$dni)){
                $resultadoFinal = $CRUD -> añadirCliente($dni,$nombre,$primerApe,$segundoApe);
            }else{
    ...
    <main class="container">
        <div id="columnaContenido">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a class="btn w-100 m-1 btn-outline-mismoColor active" href="añadirCliente.php">
            ...
            <div id="tarjetasZona" class=" p-2 pr-3">
                <form class="row p-3" id="añadirCliente" name="formularioAñadirCliente" method="POST" action="#" onsubmit="return validarFormAñadirCliente()">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="alert alert-success m-0 text-center">
                        ...
                        <span id="textoCorrecto"><b>¡Correcto!</b> Se ha añadido un cliente con exito</span>
                    </div>
                </div>
            </div>
        </div>
