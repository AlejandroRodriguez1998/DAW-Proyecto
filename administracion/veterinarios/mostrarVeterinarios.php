...
<body>
    ...
    <main class="container">
        <div id="columnaContenido">
            ...
            <div class="d-flex justify-content-between">
                <a class="btn w-100 m-1 btn-outline-mismoColor active" href="mostrarVeterinarios.php">
            ...
            <div id="tarjetasZona" class="row p-2 pr-3">
                <input id="buscadorAñadirVeterinarios" type="text" class="form-control mb-3" placeholder="Buscar...">
                            ...
                            <?php
                                ...
                                foreach($resultado as $clave => $valor){
                                    echo "<tr>";
                                        ...
                                        echo "<td>$valor[SegundoApellido]</td>";
                                    echo "</tr>";
                                }
                            ?>
                        </tbody>
    ...
    <script>
        $(document).ready(function() {
            $(document).ready(function(){
                $("#buscadorAñadirVeterinarios").on("keyup", function() {
