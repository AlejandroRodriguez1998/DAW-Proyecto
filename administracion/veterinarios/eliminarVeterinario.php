<?php
    ...
    if(isset($_POST['eliminar'])){
        ...
        $resultadoFinal = $CRUD -> eliminarMedico($dni);
    }
?>
...
<body>
    ...
    <main class="container">
        <div id="columnaContenido">
            <h2 id="tituloZona" class="text-center pt-2">Veterinario</h2>
            <div class="d-flex justify-content-between">
                ...
                <a class="btn w-100 m-1 btn-outline-mismoColor active" href="eliminarVeterinario.php">
                    <span class="d-none d-md-inline">Eliminar</span>
                    <span class="d-inline d-md-none"><i class="fa fa-trash"></i></span>
                </a>
            </div>
            <div id="tarjetasZona" class="row p-2 pr-3">
                <input id="buscadorEliminarVeterinarios" type="text" class="form-control mb-3" placeholder="Buscar...">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="alert alert-success m-0 text-center">
                        ...
                        <span id="textoCorrecto"><b>¡Correcto!</b> Se ha eliminado un veterinario con exito</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).ready(function(){
                $("#buscadorEliminarVeterinarios").on("keyup", function() {
