<?php
    ...
    if(isset($_POST['modificar'])){
        ...
        $resultadoFinal = $CRUD -> modificarMedico($dni,$nombre,$primer,$segundo);
    }
?>
...
<body>
    ...
    <main class="container">
        <div id="columnaContenido">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a class="btn w-100 m-1 btn-outline-mismoColor " href="añadirVeterinario.php">
                    <span class="d-none d-md-inline">Añadir</span>
                    <span class="d-inline d-md-none"><i class="fa fa-plus-circle"></i></span>
                </a>
                <a class="btn w-100 m-1 btn-outline-mismoColor active" href="modificarVeterinario.php">
            ...
            <div id="tarjetasZona" class="row p-2 pr-3">
                <input id="buscadorModificarVeterinarios" type="text" class="form-control mb-3" placeholder="Buscar...">
                <div class="table-responsive">
                    <table class="table table-bordered text-center">
                        ...
                        <tbody id="listaVeterinarios">
                            <?php
                                $resultado = $CRUD -> mostrarMedicos();
                                ...
                                foreach($resultado as $clave => $valor){
					                ...
					                echo  "<td><input type='text' name='nombre' value= '" . $valor["Nombre"] ."'><span class='d-none' maxlenght='30' size='20'>" . $valor["Nombre"] ."</span></td>";
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="alert alert-success m-0 text-center">
                        ...
                        <span id="textoCorrecto"><b>¡Correcto!</b> Se ha modificado un veterinario con exito</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            $(document).ready(function(){
                $("#buscadorModificarVeterinarios").on("keyup", function() {
                    var value = $(this).val().toLowerCase();
                    $("#listaVeterinarios tr").filter(function() {
