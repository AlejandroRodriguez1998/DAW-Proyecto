<?php
    ...
    if(isset($_POST['añadir'])){
        ...
        if(isset($_POST['medicos'])){
            ...
            $medico = $CRUD -> devolverMedicoAsignado($animal);
        }
        ...
        if($animal == "" || $fecha == "" || $hora == ""){
            ...
            if($diaActual < $citaFormat){
                $resultadoFinal = $CRUD -> añadirCitas($animal,$fecha,$hora,$medico);
            }else{
                $resultadoFinal = "Introduce una fecha valida";
            }
        }
    }
?>
...
<span class="d-none" id="OpcionSalir">Administracion2</span>
    ...
    <main class="container">
        <div id="columnaContenido">
            ...
            <div class="d-flex justify-content-between">
                ...
                <a class="btn w-100 m-1 btn-outline-mismoColor active" href="añadirCita.php">
            ...
            <div id="tarjetasZona" class=" p-2 pr-3">
                <form class="row p-3" id="añadirCita" name="formularioAñadirCita" method="POST" action="#" onsubmit="return validarFormAñadirCita()">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="inputAnimales">*Animal:</label>
                            <input class="form-control" id="inputAnimales" type="text" placeholder="Buscar..">
                        </div>
                        <div class="form-group">
                            <ul class="list-group selectGeneral" id="listaAnimales">
                                <?php
                                    $resultadoM = $CRUD -> mostrarAnimales();

                                    foreach($resultadoM as $claveM => $valorM){
                                        echo '<li class="list-group-item">';
                                        echo '<input type="radio" name="animales" value="'.$valorM['Tarjeta'].'" class="mr-2">';
                                        echo "(".$valorM['Tarjeta'] . ") ";
                                        if(empty($valorM['Apodo'])){
                                            echo $valorM['Nombre'];
                                        }else{
                                            echo $valorM['Apodo'];
                                        }
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="alert alert-success m-0 text-center">
                        ...
                        <span id="textoCorrecto"><b>¡Correcto!</b> Se ha añadido una cita con exito</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#inputAnimales").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#listaAnimales li").filter(function() {
                $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1)
                });
            });
        }); 
